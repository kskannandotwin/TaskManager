...
export class UpdateTaskStatusComponent implements OnInit {
  ...
  constructor(private tasksService: TasksService, private router: Router, private taskStatusesService: TaskStatusesService, private activatedRoute: ActivatedRoute) {
  }
